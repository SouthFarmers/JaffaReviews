...
public class ReviewsByUserFragment extends Fragment {
    ...
    private TextView reviewByUserName, reviewByUserStatus, reviewByUserSince, reviewByUserFollowers, reviewByUserReviews;
    private Button reviewByUserFollowButton;
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        reviewByUserFollowButton = (Button) rootView.findViewById(R.id.review_by_user_followbutton);
    ...
    public void getCriticsConnections(){
        String url ="http://jaffareviews.com/api/Movie/GetReviewsByUser?UserFbID="+userFbID;
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                searchMovies.setReleaseDate(jsonArray.getJSONObject(i).optString("TimeStamp"));
                                searchMovies.setMovieImage(jsonArray.getJSONObject(i).optString("MovieImage"));
                            ...
                            if (listUserReviewItems.size() > 0 & reviewByUserList != null) {
                                reviewByUserList.setAdapter(new ReviewsByUserAdapter(listUserReviewItems));
                            }
